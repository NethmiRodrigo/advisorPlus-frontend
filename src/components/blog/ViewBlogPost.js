            ...
            <div style={{marginLeft: "3vw", marginRight: "3vw"}}>
                <div className="card" style={{marginTop: "2vh"}}>
                    <div className="card-body">
                        ...
                        <div className="row">
                            <div className="col-3">
                                <p>by <span style={{color: "grey"}}><i>Author name comes here</i></span></p>
                            </div>
                            <div className="col-1">
                                <p>Date</p>
                            </div>
                            <div className="col-2">
                                <p>Views <span style={{color: "grey"}}>Count</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="row">
                            <div className="col-10" style={{borderRight: "1px solid green", align: "justify"}}>
                            ...
                            <div className="col-2">
                                ...
                                <button type="button" className="btn btn-secondary" style={{marginTop: "2vh"}}>
                                ...
                                <button type="button" className="btn btn-danger" style={{marginTop: "2vh"}}>
                                    <b>Report</b>
                                </button><br />
                                <button type="button" className="btn btn-primary" style={{marginTop: "2vh"}} onClick={this.openCommentModal}>
                                    <b>Comment</b>
                                </button>
                                {/* Publish comment */}
									<Modal isOpen={this.state.postCommentModal} >
										<form onSubmit={this.publishComment}>
											<div className="form-group" style={{marginBottom: "2vh"}}>
												<textarea type="text" className="form-control" id="content" placeholder="What do you want to say?" onChange={this.changeContentHandler} />
											</div>
                ...
                <div className="card" style={{marginBottom: "20%", marginTop: "1vh"}}>
                    <div className="card-body" style={{padding: "3em", paddingTop: "1em"}}>
                        {
