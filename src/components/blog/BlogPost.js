...
function BlogPost({heading, content, picSrc, author, date, tags}) {
    return (
        <div className="rounded p-1 m-1 shadow-md bg-white max-w-screen-sm">
            <div className="row">
                <div className="col">
                    <div className="text-blue-700 font-bold text-xl" style={{paddingLeft: "1vw", paddingTop: "0.3vw"}}>
				        {heading}
			        </div>
                </div>
            </div>
            <div className="row">
                <div className="col-2">
                    <div className="flex -space-x-1 overflow-hidden mt-4" style={{paddingLeft: "1vw", paddingBottom: "1vh"}}>
                        <img
                ...
                <div className="col">
                    <div className="flex -space-x-1 overflow-hidden mt-4">
                        <div className="text-s text-black text-opacity-50">
                            {tags}
                        </div>
                    </div>
                </div>
