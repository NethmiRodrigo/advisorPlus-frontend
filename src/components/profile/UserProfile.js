...
import UserProfileStyles from '../../assets/styles/UserProfileStyles.css';
                            ...
                            <div className="card bg-light">
                                <div className="card-body">
                                    <div className="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div className="mt-3">
                                            <p style={{fontSize: '2.5em'}}>John Doe</p>
                                            <p className="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
                                            <br />
                                            {/* <button className="btn btn-primary" style={{margin: '2em'}}>Edit</button>
                                            <button className="btn btn-outline-primary" style={{margin: '2em'}}>Inbox</button> */}
                            ...
                            <div className="card bg-light mt-3">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="text-secondary">https://code360.com</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="text-secondary">Code360</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div className="row gutters-sm">
                                <div className="col-sm-6 mb-3">
                                    <div className="card bg-light h-100">
                                        <div className="card-body">
                                            <h6 className="d-flex align-items-center mb-3"><i className="material-icons text-info mr-2">Interests</i>I like...</h6>
                                            <p>
                                                Lorem ipsum
                                            </p>
                                        </div>
