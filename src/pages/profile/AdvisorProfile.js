								...
								<div className="card-body">
									<div className="d-flex flex-column align-items-center text-center">
										...
										<Modal isOpen={this.state.changePicModal}>
											<form onSubmit={this.submitProfilePic}>
												...
												<button
													...
													onClick={this.unsetChangePicModal}
												>
													Cancel
												</button>
											</form>
										...
										<div className="mt-3">
											...
											<p className="text-muted font-size-sm">RATINGS</p>
											<br />
											<button
											...
											<form onSubmit={this.submitLinks}>
												<div className="form-group">
													...
													<input
														...
														className="form-control"
														id="website"
														placeholder={this.state.web}
														onChange={this.webChangeHandler}
													/>
												</div>
												<div className="form-group">
													...
													<input
														...
														onChange={this.githubChangeHandler}
													/>
												</div>
												<div className="form-group">
												...
												<div className="form-group">
													...
													<input
														...
														className="form-control"
														id="insta"
														placeholder={this.state.insta}
														onChange={this.instaChangeHandler}
													/>
												</div>
												<div className="form-group">
												...
												<form onSubmit={this.submitDetails}>
													...
													<div className="form-group">
														...
														<input
															...
															onChange={this.occupationChangeHandler}
														/>
													</div>
													<div className="form-group">
														...
														<input
															...
															onChange={this.experienceChangeHandler}
														/>
													</div>
													<button
														style={{ marginTop: "50px", marginRight: "10px" }}
													...
													<button
														style={{ marginTop: "50px", marginLeft: "10px" }}
														className="btn btn-danger"
														onClick={this.unsetDetailsModal}
													>
														Cancel
													</button>
												</form>
									...
									<div className="card bg-light h-100">
										<div className="card-body">
											<h6 className="d-flex align-items-center mb-3">
												<i className="material-icons text-info mr-2">Skills</i>I
												am good in...
											</h6>
											<SkillSet />
										</div>
								...
								<div className="col-sm-6 mb-3">
									<div className="card bg-light h-100">
										<div className="card-body">
													...
													<form onSubmit={this.submitWhoami}>
														<div className="form-group">
															...
															<textarea
																...
																className="form-control"
																id="whoami"
																placeholder={this.state.whoami}
																onChange={this.whoamiChangeHandler}
											...
											<h6 className="d-flex align-items-center mb-3">
												<i className="material-icons text-info mr-2">About</i>
												Who am I?
											</h6>
											<p>{this.state.whoami}</p>
										</div>
									</div>
								</div>
							</div>
